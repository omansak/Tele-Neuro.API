...
namespace Service.Document.Model
{
    public static class MimeTypeAssistant
    {
        ...
        public static string GetMimeType(string fileName)
        {
            ...
            if (extension.Length > 0 && MimeTypeDictionary.ContainsKey(extension.Remove(0, 1)))
            {
                return MimeTypeDictionary[extension.Remove(0, 1)];
            }
        ...
        public static string GetExtension(string mimeType)
        {
            ...
            if (mimeType.Length > 0 && MimeTypeDictionary.ContainsValue(mimeType))
            {
                return MimeTypeDictionary.First(i => i.Value == mimeType).Key;
            }
            return "unknown";
        }
